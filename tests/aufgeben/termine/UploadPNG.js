...
/**
 * Test File: UploadPNG.js
 * @Description Tests upload PNG files for Aufgeben Termine
 * Usage: node UploadPNG.js
...
var data = {
    ...
    item_amount: "5",
    'image_file_0': fs.createReadStream(__dirname + '\\image.png')
};
