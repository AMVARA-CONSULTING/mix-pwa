...
/**
 * Test File: UploadUTF8.js
 * @Description Tests upload UTF-8 image filenames for Aufgeben Termine
 * Usage: node UploadUTF8.js
...
var data = {
    ...
    item_amount: "5",
    image_file_0: fs.createReadStream(__dirname + '/© Tom Gronau © Jeanne Degraa 1200h.tif')
};
