...
/**
 * Test File: UploadTIF.js
 * @Description Tests upload TIF files for Aufgeben Termine
 * Usage: node UploadTIF.js
...
var data = {
    ...
    item_amount: "5",
    image_file_0: fs.createReadStream(__dirname + '\\image.tif')
};
